...
import { Bot, Server, Zap, ShieldCheck, ArrowRight, Clock, Sparkles } from "lucide-react";
...
export function HomePage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
          ...
          {me?.loggedIn && me.username ? (
            <>
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg border border-border-bright bg-surface-2 px-3.5 py-2 text-[13px] font-bold text-text-dim transition hover:border-red/40 hover:text-red"
              >
                <Sparkles size={14} />
                <span className="hidden sm:inline">Reboot cord AI</span>
              </button>
            </>
          ) : (
            <>
      ...
      {showAi && (
        <AiPanel
          title="Welcome to reboot cord AI"
          subtitle="helper assistant."
