...
const { sendWelcomeEmail, sendPasswordResetConfirmation, isValidEmail, sendMail, renderTemplate } = require('./email');
...
if (!process.env.SESSION_SECRET) {
  console.warn('SESSION_SECRET is not set. A random secret was generated for this process, so existing sessions will be invalidated on every restart. Set SESSION_SECRET in your environment before deploying to production.');
}
