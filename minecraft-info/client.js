const mcNavLogo = document.getElementById('mcNavLogo');
if (mcNavLogo) mcNavLogo.addEventListener('click', () => { window.location.href = '/'; });

const mcBackBtn = document.getElementById('mcBackBtn');
if (mcBackBtn) mcBackBtn.addEventListener('click', () => { window.location.href = '/dashboard'; });
