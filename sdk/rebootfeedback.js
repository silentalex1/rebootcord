(function() {
  ...
  const API_BASE = (() => {
    ...
    if (h === 'rebootcord.world' || h.endsWith('.rebootcord.world')) return 'https://rebootcord.world';
    if (p === '1000' || p === '8080' || (h === '127.0.0.1' && p !== '1000') || (h === 'localhost' && p !== '1000')) return 'http://127.0.0.1:1000';
    return '';
  })();
