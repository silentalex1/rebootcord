(function() {
  ...
  style.textContent = `
    ...
    .rbf-feedback-btn:focus-visible {
      outline: 2px solid var(--rbf-accent);
      outline-offset: 2px;
    }

    @media (prefers-reduced-motion: reduce) {
      .rbf-feedback-btn, .rbf-feedback-btn * { transition: none !important; animation: none !important; }
      .rbf-feedback-btn:hover { transform: none !important; }
    }
      ...
      const res = await fetch(API_BASE + '/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'You are PrysmisAI, a powerful real AI assistant like ChatGPT. You are integrated into this website via the /v1/chat/completions API. Be helpful, concise, friendly, and conversational.'
            },
            ...chatHistory
          ],
          max_tokens: 512
  ...
  function createChatWidget() {
    ...
    welcomeLabel.textContent = 'PrysmisAI';
