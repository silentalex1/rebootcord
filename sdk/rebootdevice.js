(function() {
  ...
  function injectStyles() {
    ...
    style.textContent =
      ...
      '.rc-device-refresh:focus-visible{outline:2px solid #2ec27e;outline-offset:2px;}' +
      '@media (prefers-reduced-motion:reduce){.rc-device-banner,.rc-device-dot,.rc-device-bar,.rc-device-text{' +
