const inboxNavLogo = document.getElementById('inboxNavLogo');
if (inboxNavLogo) inboxNavLogo.addEventListener('click', () => { window.location.href = '/dashboard'; });

const inboxBackBtn = document.getElementById('inboxBackBtn');
if (inboxBackBtn) inboxBackBtn.addEventListener('click', () => { window.location.href = '/dashboard'; });
