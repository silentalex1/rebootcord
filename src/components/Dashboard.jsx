...
export default function Dashboard({ config, onBack }) {
  const { panelUrl, apiKey } = config;
  const headers = { "x-panel-url": panelUrl, "x-api-key": apiKey };
      ...
      <aside className="w-72 border-r-4 border-black bg-[#4a3b31] flex flex-col">
        ...
        >
          ...
          <div>
            ...
            <span className="text-[10px] text-[#54ff54]">← BACK</span>
          </div>
        </div>
