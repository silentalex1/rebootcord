        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-10">
            ...
            >
              ...
              <span className="text-[10px] uppercase tracking-[0.2em]">Discord Bot Powered</span>
            </motion.div>
            ...
            <div className="space-y-4">
              ...
              >
                Connect your Discord bot and manage your bot servers. Real-time logs, file editor, and power controls — all in one place.
              </motion.p>
            </div>
          </div>
