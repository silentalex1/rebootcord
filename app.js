...
function renderOurApi() {
  ...
  navItems.forEach((item, idx) => {
    const link = el("div", { style: "padding:8px 0; cursor:pointer; font-size:13px", "data-id": item.id, onClick: () => {
      ...
      const onScroll = () => {
        ...
        if (cur) {
          ...
          document.querySelectorAll('.api-sidebar > div').forEach(div => {
            ...
            div.classList.toggle('active', did === cur || did.split('-')[0] === cur.split('-')[0]);
          });
        }
      };
