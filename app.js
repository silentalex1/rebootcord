...
function renderOurApi() {
  ...
  const sections = [
    ...
    { id: "sdks-autostyling", title: "SDKs - AutoStyling", content: () => {
      ...
      d.appendChild(el("p", { style: { fontSize: "12px", color: "#888", marginTop: "8px" } }, "Include the script tag, call RebootUI.init({apiKey: 'your_key'}), then use classes like rb-card rb-glass on your elements or helpers like createCard for professional clean UI. Only affects marked elements or when enhance() called on your container. No weird overrides on existing sites."));
      return d;
    } },
